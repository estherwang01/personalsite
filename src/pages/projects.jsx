...
const Projects = () => {
    ...
    const critterShort = () => {
        return <div id="experiences">
                ...
                The project also involved creating a multithreaded GUI where users can load custom critter specifications and visually observe behavior over time.  
                </p>
            </div>
    }
    ...
    const compilerShort = () => {
        return <div id="experiences">
                ...
                primitive ints and bools, record types, and arbitrary array types, standard control flow features, recursive functions, and multiple returns. 
                Optimizations include constant and copy propagation, dead code elimination, and efficient register allocation. 
                </p>
        </div>
    }
    ...
    const sokobanShort = () =>{
        return <div id="experiences">
            <p>
            In this project, we developed a <a href="https://en.wikipedia.org/wiki/Sokoban#:~:text=Sokoban%20(%E5%80%89%E5%BA%AB%E7%95%AA%2C%20S%C5%8Dko%2D,A%20Sokoban%20puzzle%20being%20solved."> Sokoban </a> inspired game. In a classic Sokoban game, a single player is in a maze-like 
        ...
        <div>
            ...
            <div className="projectsContainer">
                ...
                <Project width={450} link={require('../images/compiler.png')} 
                    ...
                    url={"https://github.coecis.cornell.edu/jjx6/CS4120_compiler"} 
                    caption={compiler()}tech={["Kotlin", "JFlex", "Cup", "x86"]} />
                <Project width={450} link={require('../images/sokoban.png')} 
                    title={"Simultaneous Sokoban"}  
                    short={sokobanShort()}
                    url={"https://github.coecis.cornell.edu/apf75/sokoban"} 
                    caption={sokoban()}
                    tech={["OCaml", "OCaml Graphics", "Lambda-Term"]} />
            </div>
...
export default withScreenSizeCheck(Projects);